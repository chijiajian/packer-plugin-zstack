...
func TestAttachGuestToolsToVmInstance(t *testing.T) {
	err := accountLoginCli.AttachGuestToolsIsoToVm("e2e8c1a4ebff4b5bab96ea3f58777729")
	if err != nil {
		t.Errorf("TestAttachGuestToolsIsoToVm error: %v", err)
		return
	}
}
